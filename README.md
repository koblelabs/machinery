...
[![Travis Status for koblelabs/machinery](https://travis-ci.org/koblelabs/machinery.svg?branch=master&label=linux+build)](https://travis-ci.org/koblelabs/machinery)
[![godoc for koblelabs/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/koblelabs/machinery/v1)
[![goreportcard for koblelabs/machinery](https://goreportcard.com/badge/github.com/koblelabs/machinery)](https://goreportcard.com/report/koblelabs/machinery)
[![codecov for koblelabs/machinery](https://codecov.io/gh/koblelabs/machinery/branch/master/graph/badge.svg)](https://codecov.io/gh/koblelabs/machinery)
[![Codeship Status for koblelabs/machinery](https://app.codeship.com/projects/35dc5880-71a7-0133-ec05-06b1c29ec1d7/status?branch=master)](https://app.codeship.com/projects/116961)

[![Sourcegraph for koblelabs/machinery](https://sourcegraph.com/github.com/koblelabs/machinery/-/badge.svg)](https://sourcegraph.com/github.com/koblelabs/machinery?badge)
...
```sh
go get github.com/koblelabs/machinery/v1
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/koblelabs/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/koblelabs/machinery/v1/log` package:
...
import (
  ...
  "github.com/koblelabs/machinery/v1"
)
